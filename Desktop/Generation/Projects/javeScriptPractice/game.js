const getUserChoice = userInput => {
  ...
  if(userChoice===computerChoice){
    ...
    return 'computer won!';
  } else if(userChoice=='paper'&& computerChoice==='rock' || computerChoice==='scissors') {
    return 'Computer is a winner';
  } else if(userChoice==='scissors' && computerChoice==='rock'|| computerChoice==='paper'){
  ...
  console.log(determineWinner('scissors', 'rock')); // prints something like 'The user won!' */
