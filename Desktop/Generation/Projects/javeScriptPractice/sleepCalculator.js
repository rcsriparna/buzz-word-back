const getSleepHours= day => {
   ...
   const getActualSleepHours= () => {
     const totalHrous= getSleepHours('monday') + getSleepHours('tuesday') + getSleepHours('wednesday') + getSleepHours('thursday') + getSleepHours('friday') + getSleepHours('saturday') + getSleepHours('sunday');
   return totalHrous;
   }
   ...
   const calculateSleepDebt= ()=> {
     if(getActualSleepHours===getIdealSleepHours){
       ...
       console.log(`You have ${getIdealSleepHours - getActualSleepHours} hrs of less sleep.The user should get some rest. `)} else {
         console.log(`The user got ${getActualSleepHours - getIdealSleepHours} hrsmore sleep than needed.`);
       }
   }
